...
def frmJobList():
    ...
    cols.append({'name':'WorkerId',  'title':'Табельный №', 'visible':True,  'width':100, 'readonly':False})
    ...
    frm = frmDictionary.frmTable(table, cols, frmDictionary.Size(1200,600), readonly=False) 
    return frm
